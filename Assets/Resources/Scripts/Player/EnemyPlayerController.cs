...
public class EnemyPlayerController : MonoBehaviour {
    ...
    void Start () {
        ...
        canvas = playerModel.GetComponentInChildren<Canvas>();
        userName = canvas.GetComponentInChildren<Text>();
        userName.text = Network.instance.usernamesToAllocate[PlayerID];
